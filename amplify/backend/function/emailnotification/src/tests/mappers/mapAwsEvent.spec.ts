...
describe('map aws event', () => {
    describe('missing accessories', () => {
        ...
        it('should map correctly', () => {
            ...
            expect(
                actual?.missingAccessories[0].reportedDate.toDateString(),
    ...
    describe('pickups', () => {
        ...
        it('should map first correctly', () => {
            ...
            expect(
                actual?.advertPickUps[0].reservationDate.toDateString(),
            ).toBe('Sat Jan 01 2022');
        });
        ...
        it('should map last correctly', () => {
            ...
            expect(
                actual?.advertPickUps[1].reservationDate.toDateString(),
            ).toBe('Mon Jan 10 2022');
        });
    });
});
